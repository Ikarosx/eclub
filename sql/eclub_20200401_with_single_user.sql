/*
 ...
 Source Host           : 47.112.190.215:3306
 Source Schema         : eclub
...
) ENGINE = InnoDB AUTO_INCREMENT = 1917 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `permission`  (
  `id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '权限代码',
  ...
  `icon_uri` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'icon图标地址',
  `state` tinyint(1) NOT NULL COMMENT '0正常/1禁用',
  `create_time` datetime(0) NOT NULL,
  `update_time` datetime(0) NOT NULL,
  `operator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
-- ----------------------------
INSERT INTO `permission` VALUES ('0', 'root', '根目录', '0', NULL, 0, 0, 0, '0', 0, '2020-03-30 13:37:16', '2020-03-30 13:37:19', '1');
INSERT INTO `permission` VALUES ('1', 'eclub_admin_user_add', '用户添加', '0', NULL, 0, 0, 0, NULL, 0, '2020-03-30 13:44:57', '2020-03-30 13:44:59', '1');
...
-- ----------------------------
INSERT INTO `permission_role` VALUES ('1', '1', '1', 0, '2020-03-30 13:52:58', '2020-03-30 13:53:02', '1');
...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES ('1', 'admin', '管理员', 0, '2020-03-30 13:36:12', '2020-03-30 13:36:15', '1');
...
CREATE TABLE `user`  (
  ...
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'Bcrypt加密',
  `nickname` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '昵称',
  `session_key` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '小程序session_key',
  `user_profile` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户头像地址',
  `phone` int(11) NULL DEFAULT NULL,
  `class_grade` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '班级',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', '123', 'admin', '$2a$10$0GROx419G8h5W21uCA5uUeQ/oKdAkdDZ2DwLltYw.DaaQeN7PWvWO', 'admin', NULL, '213', NULL, NULL, NULL, NULL, NULL, '123', 0, '2020-03-30 10:22:35', '2020-03-30 10:22:38', '1');
...
-- ----------------------------
INSERT INTO `user_role` VALUES ('1', '1', '1', 0, '2020-03-30 13:36:26', '2020-03-30 13:36:29', '1');
